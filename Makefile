...
#    Updated: 2024/05/01 07:22:41 by ggeorgie         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#	Replace the number after '-r' with the desired number of random numbers to generate
	$(eval ARG = $(shell jot -r 500 -2147483648 2147483647 | tr '\n' ' '))
...
#	./push_swap -1 +2 +-3 --4 ++5												# Stack with multiple signs
#	./push_swap 0 -2147483649 2147483648 1										# Stack with too high and too low values
#	valgrind --leak-check=full ./push_swap "" | ./checker_original ""			# Empty stack
#	valgrind --leak-check=full ./push_swap "2" 4 " 5" | ./checker_original "2" 4 " 5"		# Stack multiple quotation marks
#	./push_swap " 6 5 4 3 2 1	"												# Simple stack in quotation marks:
